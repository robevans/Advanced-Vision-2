...
To extract the bin\ref{fig:extracted_box_example} we used the fact that it has two orange regions.  We first converted the image to a chromaticity image to reduce the effect of lighting changes throughout the sequence, and smoothed the image with a gaussian filter to remove noise.  We 
...
Colours for region thresholding we fine-tuned manually.
